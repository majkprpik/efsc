...
const hr = {
  nav: {
    ...
    odjava: "Odjava",
    portal: "Portal",
    pokreniTutorial: "Pokreni tutorial",
    zaustaviTutorial: "Zaustavi tutorial",
    svijetlaTema: "Svijetla tema",
    tamnaTema: "Tamna tema",
  },
  common: {
  ...
  projekti: {
    ...
    novi: "Novi projekt",
    dodan: "Projekt dodan ✓",
    bezKlijenta: "Bez klijenta",
    bezNatjecaja: "Bez natječaja",
    taskovi: "Taskovi",
  ...
  natjecaji: {
    ...
    dodaj: "Novi natječaj",
    novi: "Novi natječaj",
    dodan: "Natječaj dodan ✓",
    tijelo: "Tijelo",
    sufinanciranjePolje: "Sufinanciranje",
  ...
  canvas: {
    tabPregled: "Pregled",
    tabPrijava: "Prijava",
    prazno: "Počni pisati prijavu…",
    pregled: "Pregled",
    uredi: "Uredi",
    spremljeno: "Spremljeno",
    spremam: "Spremam…",
    aiIzmijeni: "AI izmijeni",
    uputaPlaceholder: "Što da izmijenim? npr. dopuni opis ciljeva…",
    pregledIzmjena: "Pregled izmjena",
    preskoci: "Preskoči animaciju",
    primijeni: "Primijeni",
    odustani: "Odustani",
    prihvati: "Prihvati",
    odbij: "Odbij",
    nemaIzmjena: "AI nije predložio izmjene.",
    greska: "Greška.",
    povijest: "Povijest",
    povijestNaslov: "Povijest verzija",
    sada: "sada",
    trenutna: "trenutna verzija",
    verzijaAi: "AI",
    verzijaRucno: "ručno",
    spremiVerziju: "Spremi verziju",
    nazivVerzije: "Naziv verzije (npr. prije revizije mentora)",
    vrati: "Vrati ovu verziju",
    vraceno: "Verzija vraćena ✓",
    verzijaSpremljena: "Verzija spremljena ✓",
    preimenuj: "Preimenuj",
    nemaVerzija: "Još nema spremljenih verzija.",
    identicno: "Ova verzija je identična trenutnoj.",
    usporedbaSTrenutnom: "Razlika prema trenutnoj verziji",
  },
  upload: {
  ...
  potencijalni: {
    naslov: "Potencijalni",
    followUp: "Potencijalni — follow-up",
    ...
    novaBiljeska: "Napiši bilješku…",
    dodajBiljesku: "Dodaj bilješku",
    biljeskaDodana: "Bilješka dodana ✓",
    dodaj: "Nova prilika",
    novi: "Nova prilika",
    dodan: "Prilika dodana ✓",
    sazPlaceholder: "Kratko o čemu se radi…",
  },
  taskovi: {
    naslov: "Taskovi",
    moji: "Moji taskovi",
    ...
    dodajTask: "Dodaj task",
    noviTask: "Novi task",
    naziv: "Naziv",
    nazivPlaceholder: "Što treba napraviti?",
    prioritet: "Prioritet",
    bezProjekta: "Bez projekta",
    dodan: "Task dodan ✓",
    uredi: "Uredi task",
    spremljen: "Task spremljen ✓",
    obrisan: "Task obrisan ✓",
    potvrdiBrisanje: "Sigurno?",
  },
  rokovi: {
    naslov: "Rokovi",
    svi: "Svi rokovi",
  ...
  financije: {
    naslov: "Financije",
    kasni: "kasni",
    nemaTransakcija: "Nema transakcija",
...
const en: typeof hr = {
  nav: {
    ...
    odjava: "Sign out",
    portal: "Portal",
    pokreniTutorial: "Start tutorial",
    zaustaviTutorial: "Stop tutorial",
    svijetlaTema: "Light theme",
    tamnaTema: "Dark theme",
  },
  common: {
    ucitavanje: "Loading…",
  ...
  projekti: {
    ...
    novi: "New project",
    dodan: "Project added ✓",
    bezKlijenta: "No client",
    bezNatjecaja: "No tender",
    taskovi: "Tasks",
  ...
  natjecaji: {
    ...
    dodan: "Tender added ✓",
    tijelo: "Authority",
    sufinanciranjePolje: "Co-financing",
  ...
  canvas: {
    tabPregled: "Overview",
    tabPrijava: "Application",
    prazno: "Start writing the application…",
    pregled: "Preview",
    uredi: "Edit",
    spremljeno: "Saved",
    spremam: "Saving…",
    aiIzmijeni: "AI edit",
    uputaPlaceholder: "What should I change? e.g. expand the objectives…",
    pregledIzmjena: "Review changes",
    preskoci: "Skip animation",
    primijeni: "Apply",
    odustani: "Cancel",
    prihvati: "Accept",
    odbij: "Reject",
    nemaIzmjena: "The AI proposed no changes.",
    greska: "Something went wrong.",
    povijest: "History",
    povijestNaslov: "Version history",
    sada: "now",
    trenutna: "current version",
    verzijaAi: "AI",
    verzijaRucno: "manual",
    spremiVerziju: "Save version",
    nazivVerzije: "Version name (e.g. before mentor review)",
    vrati: "Restore this version",
    vraceno: "Version restored ✓",
    verzijaSpremljena: "Version saved ✓",
    preimenuj: "Rename",
    nemaVerzija: "No saved versions yet.",
    identicno: "This version is identical to the current one.",
    usporedbaSTrenutnom: "Difference from the current version",
  },
  upload: {
  ...
  potencijalni: {
    ...
    sazUnos: "Idea description",
    biljeske: "Notes",
    nemaBiljeski: "No notes",
    novaBiljeska: "Write a note…",
    dodajBiljesku: "Add note",
    biljeskaDodana: "Note added ✓",
    dodaj: "New lead",
    novi: "New lead",
    dodan: "Lead added ✓",
    sazPlaceholder: "Briefly what this is about…",
  },
  taskovi: {
    naslov: "Tasks",
    moji: "My tasks",
    ...
    noviTask: "New task",
    naziv: "Title",
    nazivPlaceholder: "What needs doing?",
    prioritet: "Priority",
    bezProjekta: "No project",
    dodan: "Task added ✓",
    uredi: "Edit task",
    spremljen: "Task saved ✓",
    obrisan: "Task deleted ✓",
    potvrdiBrisanje: "Sure?",
  },
  rokovi: {
    naslov: "Deadlines",
    svi: "All deadlines",
  ...
  financije: {
    naslov: "Finances",
    kasni: "overdue",
    nemaTransakcija: "No transactions",
